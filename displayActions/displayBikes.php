<!DOCTYPE html>
    ...
    <body>
        ...
        <table>
            ...
            <th>Grosime Roată</th>
            <th>Preț Oră</th>
            <th>Data Aducerii În Centru</th>

    <?php
    //conectarea la baza de date
    $conn = mysqli_connect("localhost","root","","centrubiciclete3");
   
    //select din tabelul biciclete pentru a afisa ulterior informatii despre acestea
    $date = "SELECT Marca,Culoare,Categorie_Varsta,Grosime_Roata,Data_Sosire_In_Centru, Pret_Ora,Data_Sosire_In_Centru from biciclete";
    ...
    if ($rezultat -> num_rows > 0)
    {
        ...
        {   //afisarea datelor in tabel
            echo "<tr><td>". $row["Marca"]. "</td><td>".  $row["Culoare"]. "</td><td>". 
             $row["Categorie_Varsta"]. "</td><td>". $row["Grosime_Roata"]. "</td><td>". $row["Pret_Ora"]."</td><td>". $row["Data_Sosire_In_Centru"]."</td><td>";
        }
        echo "</table>";
    }
    else
