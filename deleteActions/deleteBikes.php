<!DOCTYPE html>
    ...
    $date = "SELECT ID_Bicicleta,Marca,Culoare,Categorie_Varsta,Grosime_Roata,Data_Sosire_In_Centru, Pret_Ora from biciclete";
    ...
    if ($rezultat -> num_rows > 0)
    {
        ...
        {   //afisarea datelor si a link-ului catre urmatoarea pagina(+datele curente necesare stergerii)
            echo "<tr>
                  ...
                  <td>". $row["Pret_Ora"]."</td>
                  <td><a href = 'deleteBike.php?rn=$row[ID_Bicicleta]'>Ștergere</td>
                  </tr>";
        }
        echo "</table>";
    }
